...
import com.agcheb.instagramclient.Services.ServiceManager;
        ...
        response.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d("UltraImportantTag"," "+response.body());
                    hidePD();
                    ...
                    try {
                        ...
                        Log.d("UltraImportantTag2"," дошли до цикла");
...
//                            mMinId = pagination.getString("next_min_id");
                            ...
                            Log.d("UltraImportantTag2","вошли в цикл " + data.toString());

                            for (int j = 0; j < data.length(); j++) {

                                JSONArray tags = data.getJSONObject(j).getJSONArray("tags");

                                Log.d("UltraImportantTag2","вошли в внутренний цикл ");
